        ...
        <section>
            ...
            <div class="trend-grid">
                <div class="trend-card">
                    ...
                    <div class="trend-widget-container" style="height: 500px; width: 100%;"><iframe src="https://sslcharts.investing.com/index.php?force_lang=30&pair_ID=23705&timescale=86400&candles=100&style=line" width="100%" height="100%" frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0"></iframe></div>
                </div>
                <div class="trend-card">
