        ...
        <section>
            ...
            <div class="trend-grid">
                <div class="trend-card">
                    <h4>US 10Y Yield</h4>
                    <div class="trend-widget-container"><script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-mini-symbol-overview.js" async>{{"symbol": "CAPITALCOM:US10Y", "width": "100%", "height": "100%", "locale": "zh_TW", "dateRange": "1M", "colorTheme": "light", "isTransparent": true}}</script></div>
                </div>
                <div class="trend-card">
                    <h4>Dollar Index</h4>
